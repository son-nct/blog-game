    ...
    <div class="mx-6 py-10 text-center md:text-left">
      <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div class="">
          ...
          <p class="text-sm">
            VIETNAM ENTERTAINMENT AND E-sports JOINT STOCK COMPANY
            Head office address: 29th floor, Lotte Center Hanoi building, number 54, Lieu Giai street,
            Cong Vi Ward, Ba Dinh District, Hanoi City, Vietnam.
            Phone: 024 73053939
          </p>
        </div>
